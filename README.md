...
Bem-vindo ao meu repositório de documentações, relatórios técnicos e diagramas desenvolvidos durante a minha graduação. 

O objetivo deste espaço é demonstrar minha capacidade de planejamento, modelagem de sistemas e entendimento de regras de negócio, que são as bases fundamentais antes de escrever qualquer linha de código.
...
* Modelagem de Dados e Diagramas UML
* Escrita Técnica e Criação de Manuais
* Lógica de Programação e Algoritmos

---
*Sinta-se à vontade para explorar os documentos. Para visualizar os arquivos `.pdf`, basta clicar neles e o próprio GitHub abrirá o leitor no navegador.*
